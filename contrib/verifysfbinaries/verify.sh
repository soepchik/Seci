...
SIGNATUREFILE="http://downloads.sourceforge.net/project/seci/Straks/seci-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/seci/Straks/"
VERSIONPREFIX="seci-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'seci-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[seci-]<version>-[rc[0-9]] (example: seci-0.7.1-rc1)"
   echo "wget output:"
