...
# TestNode: A peer we use to send messages to secid, and store responses.
...
class CompactBlocksTest(StraksTestFramework):
    ...
    # This test actually causes secid to (reasonably!) disconnect us, so do this last.
    ...
    # Test that secid requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for secid to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # secid will not send blocktxn responses for blocks whose height is
