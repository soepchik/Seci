...
---------------------
	...
	strip src/secid src/seci-cli src/qt/seci-qt

	make install # optional

This will build seci-qt as well if the dependencies are met.
...
Security
--------
To help make your SECI installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, seci should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, seci may be compiled in
