...
Clone the git repositories for seci and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/seci/seci
```
...
In [doc/release-process.md](release-process.md) in the seci repository under 'Fetch and build inputs'.
...
gitian builds' in [doc/release-process.md](release-process.md) in the seci repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/seci/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/seci/seci
...
For example:
```bash
URL=https://github.com/laanwj/seci.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit seci=${COMMIT} --url seci=${URL} ../seci/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit seci=${COMMIT} --url seci=${URL} ../seci/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/seci-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/seci-build.assert
```
...
[seci/gitian.sigs](https://github.com/seci/gitian.sigs/) repository, or
