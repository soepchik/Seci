The following is a list of assets used in the seci source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original seci logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/seci.icns, src/qt/res/src/seci.svg,
	src/qt/res/src/seci.ico, src/qt/res/src/seci.png,
	src/qt/res/src/seci_testnet.png, docs/seci_logo_doxygen.png,
