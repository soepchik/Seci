...
###### Masternodes: Enabled
###### Masternodes Collateral: 15,000 SECI
...
Masternodes will be supported with a collateral requirement of **15,000 SECI**.  

The collateral requirement is a dynamic target value and will be updated for future
releases based on the market price of SECI and return on investment relative to
its peer group.
...
In the spirit of full transparency please read the following information carefully and ask questions on the SECI Discord server if you are unsure of anything.
...
Instead of premine, primarily due to the new REV1 payment rebalancing algorithm requiring tracking of supply information, an instamine was added to Block 1 for the total of **41,215,000 SECI**.  

The calculation of the swap and developer funds buffer is as follows:

```
Swap Ratio: 4 SIGT : 1 SECI 
...
SECI Swap Allocation: 34,375,000 SECI
SECI Swap Allocation (% of Max Supply): 22.9%

SECI Developers Allocation: 6,875,000 SECI
SECI Developers Allocation (% of Max Supply): 4.6%
```
...
Once the swap-process is initiated, Signatum coin-holders will have a 30 day window, whereby they can swap their coins from Signatum to SECI at the 4:1 ratio.
