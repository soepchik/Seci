/* src/config/seci-config.h.  Generated from seci-config.h.in by configure.  */
/* src/config/seci-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SECI_CONFIG_H

#define SECI_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "SECI developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SECI"
...
#define PACKAGE_BUGREPORT "https://github.com/seci/seci/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SECI Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SECI Core 1.14.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "seci"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://seci.info/"
