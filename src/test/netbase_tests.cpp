...
{
    BOOST_CHECK(TestSplitHost("www.seci.org", "www.seci.org", -1));
    BOOST_CHECK(TestSplitHost("[www.seci.org]", "www.seci.org", -1));
    BOOST_CHECK(TestSplitHost("www.seci.org:80", "www.seci.org", 80));
    BOOST_CHECK(TestSplitHost("[www.seci.org]:80", "www.seci.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9819", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9819", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9819", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:9819", "::", 8333));
    BOOST_CHECK(TestSplitHost("::9819", "::9819", -1));
    BOOST_CHECK(TestSplitHost(":9819", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:9819", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9819", "127.0.0.1:9819"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9819", "[::]:9819"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
