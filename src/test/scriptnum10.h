...
#ifndef SECI_TEST_SCRIPTNUM10_H
#define SECI_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from seci Core 0.10.0, for cross-comparison.
 */
public:
