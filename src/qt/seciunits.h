...
#ifndef SECI_QT_SECIUNITS_H
#define SECI_QT_SECIUNITS_H
...
/** seci unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class seciUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit seciUnits(QObject *parent);

    /** seci units.
      @note Source: https://en.seci.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SECI,
...
typedef seciUnits::Unit seciUnit;

#endif // SECI_QT_SECIUNITS_H
