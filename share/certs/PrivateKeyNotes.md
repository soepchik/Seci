...
allowing somebody to distribute a Straks-Qt.app or seci-qt-setup.exe with a valid
...
that the seci-qt.exe file inside the installer had not been tampered with.
